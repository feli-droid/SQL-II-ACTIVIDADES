...
BEGIN
    ...
    -- Cambia 'id_cuenta' si en tu tabla tiene otro nombre
...
-- Ajusta la consulta usando los nombres correctos de columna de 'cuentas':
SELECT id_cuenta, saldo, EvaluarElegibilidadCredito(id_cuenta) AS Estado_Credito 
FROM cuentas;
